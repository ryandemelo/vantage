...
(function (root) {
  ...
  VG.TAXONOMY = [
    ...
    },
    {
      ...
      colour: '#8B5CF6',
      terms: [
        ['policy', 4], ['legislation', 5], ['regulation', 4], ['statute', 4],
    ...
    },
    {
      ...
      terms: [
        ...
        ['quotation', 4], ['sla', 4], ['terms and conditions', 4], ['gebiz', 6]
      ],
      patterns: [],
    ...
    },
    {
      ...
      terms: [
        ...
        ['member of the public', 6], ['citizen', 4], ['resident', 3],
    ...
    },
    {
      ...
      patterns: [],
      // Anything with code or agency vocabulary is work, whatever else it says.
      anti: [[/```/, -8], [/\b(agency|ministry|department|division|the public|stakeholder)\b/i, -4]]
    },
    {
      id: 'other',
      label: 'Uncategorised',
  ...
  VG.MANAGED_KEYS = [
    ...
    'reportSigningKey',
    'orgAgency', 'orgDivision', 'orgCohort', 'agencyDomainMap',
